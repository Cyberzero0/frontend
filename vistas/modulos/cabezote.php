		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 social">
				...
				<ul>
					...
					//MANEJO DE REDES DE FOMRA DINAMICA DESDE DB
				...
				<div class="input-group col-lg-8 col-md-8 col-sm-8 col-xs-12" id="buscador">
					...
					<span class="input-group-btn">
						...
						<a href="<?php echo $url; ?>buscador/1/recientes">
							...
							<button class="btn btn-default backColor" type="submit" style="border-bottom-right-radius: 10px; border-top-right-radius: 10px;">
			...
			<!--CARRITO DE COMPRAS</!-->
				<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="carrito">
					<a  href="<?php echo $url;?>carrito-de-compras">
						...
						<button class="btn btn-default pull-left backColor" style="border-radius: 10px;">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>

						</button>

					</a>
				<p style="color: white; border: none; border-color: transparent;">TU CESTA <span style="border: none; border-color: transparent;" class="cantidadCesta"></span><br>MXN $ <span style="border: none; border-color: transparent;" class="sumaCesta"></span></p>
				</div>
		</div>
<!--CATEGORIAS</!-->
		...
		<div class="modal-body modalTitulo">
			...
			<form method="post">
				...
				<center>
					...
					<a href="#modalPassword" data-dismiss="modal" data-toggle="modal">Olvidaste tu password?</a>
				</center>
			</form>
...
<div class="modal fade modalFormulario" id="modalPassword" role="dialog">
	...
	<div class="modal-content modal-dialog">
		...
		<div class="modal-body modalTitulo">
			...
			<h3 class="backColor"> SOLICITUD DE NUEVA PASSWORD</h3>
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<!-- OLVIDO PASSWORD -->
			<form method="post">
				<label class="text-muted">Escribe el correo electronico con el que estas registrado y alli te enviaremos una nueva password:</label>
				<hr>
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon">
