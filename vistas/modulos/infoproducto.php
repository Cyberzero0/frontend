					...
					echo '<div class="col-md-5 col-sm-6 col-xs-12 visorImg">
							...
							if($multimedia != null){
								...
								for($i = 0; $i < count($multimedia); $i ++){
									...
									//var_dump($multimedia, $multimedia[$i]);
			...
			?>
				...
				<div class="col-xs-6">
					...
					<h6>
						...
						<ul style="background-color: black" class="dropdown-menu pull-right compartirRedes">
				...
				<?php
					...
					if($infoproducto["oferta"] == 0){
						...
						$fecha = date('Y-m-d');
						$fechaActual = strtotime('-15 day',strtotime($fecha));
