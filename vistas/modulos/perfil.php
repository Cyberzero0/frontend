...
<div class="container-fluid well well-sm" id="barraCarrito">
	...
	<div class="container">
		...
		<div class="row">
			...
			<ul class="breadcrumb fondoBreadcrumb text-uppercase">
				...
				<li><a style="color: skyblue;" href="<?php echo $url;  ?>">INICIO</a></li>
				<li style="color: white;" class="active pagActiva"><?php echo $rutas[0] ?></li>
												...
												$comentarios = ControladorUsuarios::ctrMostrarComentariosPerfil($datos);
															...
															echo '<div class="pull-right">';
																if(is_array($comentarios)){
																		...
																		echo '<a class="calificarProducto" href="#modalComentarios" data-toggle="modal" idComentario="'.$comentarios["id"].'">
																	
																		<button class="btn btn-default backColor">Calificar Producto</button>

																		</a>';
																}else{echo '<a class="calificarProducto" href="#modalComentarios" data-toggle="modal" idComentario="">
														...
														echo '<p class="panel panel-default text-right" style="padding:5px">
															...
															Califique este producto para mostrar su comentario en este apartado.
					...
					<form method="post" enctype="multipart/form-data">
						...
						if($_SESSION["modo"] != "directo"){
							...
							echo '<label class="control-label text-muted text-uppercase" for="editarNombre">Cambiar Nombre:</label>
								...
								<label class="control-label text-muted text-uppercase" for="editarDireccion">Cambiar Direccion:</label>
									
									<div class="input-group">
								
										<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
										<input type="text" class="form-control" id="editarDireccion" name="editarDireccion" value="'.$_SESSION["direccion"].'">
