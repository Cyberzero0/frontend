			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('gruposenclay@gmail.com', 'Senclay');

					$mail->addReplyTo('gruposenclay@gmail.com', 'Senclay');
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						$mail->setFrom('gruposenclay@gmail.com', 'Tutoriales a tu Alcance');

						$mail->addReplyTo('gruposenclay@gmail.com', 'Tutoriales a tu Alcance');
		...
		if(isset($_POST["editarNombre"])){
			...
			if(isset($_FILES["datosImagen"]["tmp_name"]) && !empty($_FILES["datosImagen"]["tmp_name"])){
				...
				if($_FILES["datosImagen"]["type"] == "image/jpeg"){
					...
					//MODIFICAMOS EL MANO DE LA FOTO
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				date_default_timezone_set("America/Mexico_City");
					...
					$mail->addAddress("gruposenclay@gmail.com");
