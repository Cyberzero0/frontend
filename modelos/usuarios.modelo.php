...
class ModeloUsuarios{
	...
	static public function mdlMostrarComentariosPerfil($tabla, $datos){
		...
		if($datos["idUsuario"] != ""){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE id_producto = :id_producto ORDER BY calificacion DESC");
	...
	//ELIMINAR COMENTARIOS DE USUARIO ELIMINADO
	...
	//ELIMINAR COMPRAS DE USUARIO ELIMINADO
	...
	//ELIMINAR TODOS LOS DESEOS DEL USUARIO ELIMINADO
